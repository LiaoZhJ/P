...
// MFCApplication17.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CMFCApplication17App 对象

CMFCApplication17App theApp;


// CMFCApplication17App 初始化
...
BOOL CMFCApplication17App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCApplication17Doc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CMFCApplication17View));
	if (!pDocTemplate)
		return FALSE;
