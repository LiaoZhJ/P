...
{
	// TODO: 在此添加一次性构造代码
	CRA.top = 50;	CRA.left = 100;
	CRA.bottom = 250; CRA.right = 300;
	CRB.top = 50;	CRB.left = 500;
	CRB.bottom = 250; CRB.right = 700;
	CRC.top = 300;	CRC.left = 300;
	CRC.bottom = 500; CRC.right = 500;
	r1 = 0; r2 = 0;
}
