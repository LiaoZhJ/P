...
// MFCApplication9.cpp : 定义应用程序的类行为。
//
...
// CMFCApplication9App 构造

CMFCApplication9App::CMFCApplication9App()
{
	// 支持重新启动管理器
...
// 唯一的一个 CMFCApplication9App 对象

CMFCApplication9App theApp;


// CMFCApplication9App 初始化
