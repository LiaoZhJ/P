...
BEGIN_MESSAGE_MAP(CMFCApplication20App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCApplication20App::OnAppAbout)
	// 基于文件的标准文档命令
...
CMFCApplication20App::CMFCApplication20App()
{
	...
	SetAppID(_T("MFCApplication20.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CMFCApplication20App 对象
...
BOOL CMFCApplication20App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCApplication20Doc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CMFCApplication20View));
	if (!pDocTemplate)
		return FALSE;
...
int CMFCApplication20App::ExitInstance()
{
	//TODO: 处理可能已添加的附加资源
	AfxOleTerm(FALSE);
...
// 用于运行对话框的应用程序命令
void CMFCApplication20App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
